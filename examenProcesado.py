...
# que convierte la fecha y hora en segundos transcurridos desde el 1 de enero de 1970.
    ...
    sampling_strategy = sampling_strategy = {0: 9, 1: 9, 2: 9}
        ...
        if(k%2!=0):
            for d in range(int(Dmin),int(Dmax)):
                ...
                # Build scored dataset
                    ...
                    if os.path.isfile('resultadosExamenMulticlassPreprocesado.csv'):
                        # Append classification report to the file
                        df = pd.read_csv('resultadosExamenMulticlassPreprocesado.csv')
                        ...
                        df.to_csv('resultadosExamenMulticlassPreprocesado.csv', index=False)
                    else:
